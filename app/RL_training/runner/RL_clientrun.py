...
sys.path.append('../../../')
from app.RL_training.RLEnv import RL_Client
...
rl_client = RL_Client(index, ip_address, config.SERVER_ADDR, config.SERVER_PORT, datalen, config.model_name,
                      split_layer, config.model_cfg)
