...
HOST2IP = {}
CLIENTS_NAME_TO_INDEX = {'client1': 0, 'client2': 1, 'client3': 2, 'client4': 3}
EDGE_SERVER_LIST = ['edge1', 'edge2']
CLIENTS_LIST = ['client1', 'client2', 'client3', 'client4']
EDGE_NAME_TO_CLIENTS_NAME = {'edge1': ['client1', 'client2'], 'edge2': ['client3', 'client4']}
CLIENT_NAME_TO_EDGE_NAME = {'client1': 'edge1', 'client2': 'edge1', 'client3': 'edge2', 'client4': 'edge2'}
